...
The provided files are basically static HTML files that would need to be changed over to the templating language of your choice, using a Static Site Generator to build the site.
